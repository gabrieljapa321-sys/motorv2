...
class BrowserSmokeTests(unittest.TestCase):
    ...
    def test_work_task_flow_waiting_done_and_persistence(self):
        self._goto()
        self.page.click(".tb-nav-btn[data-nav-page='work']")
        self.page.wait_for_selector("#workPage")
        self.page.click("[data-work-capture-toggle='true']")
        self.page.wait_for_selector("#workTaskForm")
        ...
        self.page.wait_for_selector(".wk-task:has-text('Revisar indicadores BENEVA')")
        self.assertTrue(self.page.locator(".wk-task:has-text('BENEVA')").first.is_visible())
        self.page.click(".wk-task:has-text('Revisar indicadores BENEVA') [data-work-status='waiting']")
        self.page.wait_for_timeout(250)
        self.assertTrue(self.page.locator(".wk-mini-task:has-text('Revisar indicadores BENEVA')").first.is_visible())
        self.page.locator(".wk-mini-task:has-text('Revisar indicadores BENEVA') [data-work-status='done']").first.click()
        self.page.wait_for_timeout(250)
        self.assertEqual(self.page.locator(".wk-task:has-text('Revisar indicadores BENEVA')").count(), 0)
        self.page.reload(wait_until="domcontentloaded")
